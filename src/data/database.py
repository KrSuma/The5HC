...
from src.data.database_config import get_db_connection, DatabaseError, execute_query
...
def init_db():
    ...
    try:
        with get_db_connection() as conn:
            ...
            c.execute('''CREATE TABLE IF NOT EXISTS session_packages
                         (id INTEGER PRIMARY KEY AUTOINCREMENT,
                          client_id INTEGER NOT NULL,
                          trainer_id INTEGER NOT NULL,
            ...
            indexes = [
                ...
                "CREATE INDEX IF NOT EXISTS idx_training_sessions_package ON training_sessions(package_id)",
                ...
                "CREATE INDEX IF NOT EXISTS idx_payment_records_trainer ON payment_records(trainer_id)",
            ]
