/**
 * Simplified Alpine.js component for MCQ assessment
 */

console.log('MCQ Assessment Simple script loaded!');

document.addEventListener('alpine:init', () => {
    console.log('Alpine init - registering mcqAssessment component');
    Alpine.data('mcqAssessment', (existingResponses = {}) => ({
        ...
        submitAssessment() {
            this.isLoading = true;
            console.log('Submitting assessment with responses:', this.responses);
    ...
    console.log('mcqAssessment component registered successfully!');
});